...
<tr>
  ...
  <img src="<?=URL::Base()?><?=str_replace(Config::FolderProject(),'',str_replace('/files/', '/thumbs/', $row['file_path']))?>" class="mc_preload wp-post-image" alt="<?=$row['deskripsi']?>" title="" style="display: block;">
  <?php } if($edited) {?>
  <a data-toggle="modal" class="btn btn-warning" href="javascript:void('')" data-target="#myModal">File Manager</a>
  <?php }?>
  </td>
</tr>
<tr><td class="td-label">Deskripsi</td><td><?php echo UI::createTextArea('deskripsi',$row['deskripsi'],'','',$edited,$class='form-control')?></td></tr>
<tr><td class="td-label">Tampil Didepan</td><td><?php echo UI::createCheckBox('is_aktif',1,$row['is_aktif'],$edited,$class='')?></td></tr>
<?php if($edited){?>
